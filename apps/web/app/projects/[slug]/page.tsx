      ...
      <div className="main">
        ...
        >
          ...
          <div className="admin-card" style={{ padding: 32 }}>
            ...
            <div className="proj-tech" style={{ marginTop: 12, marginBottom: 0 }}>
              {project.stack.map((s) => (
                <span key={s} className="tc">{s}</span>
              ))}
            </div>
          </div>
            ...
            <div className="admin-card" style={{ padding: 32 }}>
              ...
              <div className="proj-tech" style={{ marginTop: 12, marginBottom: 0 }}>
                {project.learnings.map((l) => (
                  <span key={l} className="tc">{l}</span>
                ))}
              </div>
            </div>
          )}
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginTop: 8 }}>
            {project.demoLink && (
              <a className="admin-btn" href={project.demoLink} target="_blank" rel="noopener noreferrer">
                Live Demo →
              </a>
            )}
            {project.githubLink && (
              <a className="admin-btn secondary" href={project.githubLink} target="_blank" rel="noopener noreferrer">
                GitHub →
              </a>
            )}
            <a className="admin-btn secondary" href="/projects">← All Projects</a>
          </div>
        </div>
      </div>
