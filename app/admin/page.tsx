    ...
    <>
      ...
      <div className="admin-card">
        ...
        <p style={{ fontSize: 14, color: "var(--muted)", lineHeight: 1.7 }}>
          Saved changes are committed to the GitHub repository as JSON files
          under <code>data/</code>. Cloudflare Pages auto-rebuilds when the push
          lands, and the site updates within ~30–60 seconds.
        </p>
      </div>
    </>
  );
